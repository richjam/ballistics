...
@export var ball_id: int = 0  ## Unique ID for each ball type
...
# Dictionary to map ball numbers to textures
var ball_textures = {
	0: preload("res://assets/sprites/balls/cue_ball.png"),
	1: preload("res://assets/sprites/balls/ball1.png"),
	2: preload("res://assets/sprites/balls/ball2.png"),
}
...
func _ready() -> void:
	""" Initialize the ball in a stopped state.
	"""
	$BallSprite.texture = ball_textures[ball_id]
